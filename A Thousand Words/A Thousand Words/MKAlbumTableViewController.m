...
#import "MKAlbumTableViewController.h"
#import "Album.h"
#import "MKCoreDataHelper.h"

@interface MKAlbumTableViewController () <UIAlertViewDelegate>

@end

@implementation MKAlbumTableViewController
...
- (void)viewWillAppear:(BOOL)animated
{
    ...
    NSError *error = nil;
    NSArray *fetchedAlbums = [[MKCoreDataHelper managedObjectContext] executeFetchRequest:fetchRequest error:&error];
...
{
    NSManagedObjectContext *context = [MKCoreDataHelper managedObjectContext];
